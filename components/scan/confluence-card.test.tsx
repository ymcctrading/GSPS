    ...
    const result: ScanResult = {
      ...
      signals: {
        ...
        gannConfluence: {
          ...
          timeCycleSeasonalActive: false,
          timeCycleSeasonalDates: [],
          timeCycleHolidayActive: false,
          timeCycleHolidayDates: [],
          decadeCycle: { yearDigit: 5, bias: "bullish", label: "Year of Ascension", note: "" },
          vortexContext: {
            priceDisplacement: {
              rawValue: 25,
              normalizationMethod: "price_displacement_ticks",
              integerValue: 25,
              mod9Residue: 7,
              activeDigitalRoot: 7,
              inputTimestamp: "x",
